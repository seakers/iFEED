...
class FeatureApplication{
    ...
    convert_to_CNF(){
        ...
        $.ajax({
            url: "/api/eoss/analyst/convert-to-CNF",
            type: "POST",
            data: {
                    expression: feature,
                  },
    ...
    simplify_feature(){
        ...
        $.ajax({
            url: "/api/eoss/analyst/simplify-feature-expression",
            type: "POST",
            data: {
    ...
    convert_to_DNF(){
        ...
        $.ajax({
            url: "/api/eoss/analyst/convert-to-DNF",
            type: "POST",
            data: {
                    expression: feature,
                  },
    ...
    compute_algebraic_complexity(feature){
        ...
        $.ajax({
            url: "/api/eoss/analyst/compute-complexity",
            type: "POST",
            data: {
                    expression: feature,
                  },
    ...
    compute_algebraic_typicality(input, feature){
        ...
        $.ajax({
            url: "/api/eoss/analyst/compute-typicality",
            type: "POST",
            data: {
