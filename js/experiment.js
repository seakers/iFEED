...
let fuzzy_pareto_front_8_mid_538_list = [];
let fuzzy_pareto_front_8_mid_538_temp = fuzzy_pareto_front_8_mid_538.split(",");
for(let i = 0; i < fuzzy_pareto_front_8_mid_538_temp.length; i++){
    fuzzy_pareto_front_8_mid_538_list.push(+fuzzy_pareto_front_8_mid_538_temp[i]);
}
